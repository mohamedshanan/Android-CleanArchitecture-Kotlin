...
import com.masary.anamasary.features.codeverification.CodeVerificationFailure.InvalidVerificationCode
...
class CodeVerificationFragment : BaseFragment() {
    ...
    private fun renderKey(keyModel: EncryptionKeyModel?) {
        keyModel?.let {
            activity?.let {
                Toast.makeText(it, keyModel.key, Toast.LENGTH_LONG)
            }
        }
    }
